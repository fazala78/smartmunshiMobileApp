...
import { fetchRawProducts } from '../services/RawProductService';
import ApiDropdown from '../components/ui/ApiDropdown';

type Props = {
    navigation: NativeStackNavigationProp<RootStackParamList, 'rawProducts'>;
};

const RawProductsScreen: React.FC<Props> = ({ navigation }) => {
    ...
    const {
        ...
        queryFn: async ({ pageParam }: { pageParam: number }) => {
            ...
            const response = await fetchRawProducts(filterParams);
            return response;
        },
    ...
    const handleProductPress = useCallback(
        (product: Product) => {
            navigation.navigate('rawProductLedger', { product: product });
        },
        [navigation]
    );
            ...
            >
                <View style={styles.productLeft}>
                    ...
                    <View style={styles.productInfo}>
                        ...
                        <Text style={styles.productPrice}>
                           {formatBalance(item.cost, currency as Currency)}
                        </Text>
                    </View>
                </View>
    ...
    return (
        <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
            ...
            <Header title='Raw Products' navigation={navigation} />
                 ...
                 <ApiDropdown
                    ...
                    <View style={{ height: 15}} />
                     <ApiDropdown
                        label="Lots"
                        url="/lot-search"
                        value={draftFilters.lots}
                        multiple
                        zIndex={2000}
                        onValueChange={(v) =>
                            setDraftFilters((p: any) => ({ ...p, lots: v as string[] }))
                        }
                    />
            </FilterModal>
        </SafeAreaView>
...
export default RawProductsScreen;