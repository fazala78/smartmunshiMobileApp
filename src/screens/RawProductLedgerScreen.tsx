...
import { getRawProductTransactions } from '../services/RawProductService';
...
const RawProductLedgerScreen: React.FC<Props> = ({ route }) => {
    ...
    const {
        ...
        queryKey: ['rawProductLedger', route.params.product.id, filters],
        queryFn: async ({ pageParam }: { pageParam: number }) => {
            const response = await getRawProductTransactions(route.params.product.id, {
                page: pageParam,
                search: {
            ...
            <View style={styles.transactionItem}>
                ...
                <View style={styles.transactionDescriptionContainer}>
                    <Text style={styles.transactionTypeText} numberOfLines={1}>
                        {formatTransactionType(item.transaction)} #{item.transaction_id}
                    </Text>
                    {item.lot && (
            ...
            <SafeAreaView style={styles.safeArea}>
                ...
                <View style={styles.profileSection}>
                     <View style={styles.avatar}>
                                           <Icon name="inventory" size={26} color={colors.warning} />
                                       </View>
...
export default RawProductLedgerScreen;
